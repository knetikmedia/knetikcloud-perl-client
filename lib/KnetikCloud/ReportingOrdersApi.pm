...
#
package KnetikCloud::ReportingOrdersApi;
...
# @param int $page The number of the page returned (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_invoice_reports' } = { 
...
#
sub get_invoice_reports {
    my ($self, %args) = @_;

    # verify the required parameter 'currency_code' is set
    unless (exists $args{'currency_code'}) {
      croak("Missing the required parameter 'currency_code' when calling get_invoice_reports");
    }
