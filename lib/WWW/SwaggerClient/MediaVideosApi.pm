...
sub delete_relationship_using_delete {
    ...
    # verify the required parameter 'video_id' is set
    unless (exists $args{'video_id'}) {
      croak("Missing the required parameter 'video_id' when calling delete_relationship_using_delete");
    }
...
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_related_using_get' } = { 
        ...
        params => $params,
        returns => 'PageVideoRelationshipResource',
        };
}
...
sub get_related_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageVideoRelationshipResource', $response);
    return $_response_object;
}
...
sub get_user_videos_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageVideoResource', $response);
    return $_response_object;
}
...
sub update_relationship_using_put {
    ...
    # verify the required parameter 'video_id' is set
    unless (exists $args{'video_id'}) {
      croak("Missing the required parameter 'video_id' when calling update_relationship_using_put");
    }

    # verify the required parameter 'relationship_id' is set
    unless (exists $args{'relationship_id'}) {
      croak("Missing the required parameter 'relationship_id' when calling update_relationship_using_put");
    }
