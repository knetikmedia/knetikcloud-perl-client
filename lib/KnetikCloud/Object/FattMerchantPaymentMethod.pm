...
#
package KnetikCloud::Object::FattMerchantPaymentMethod;
...
__PACKAGE__->method_documentation({
    ...
    'customer_id' => {
    	...
    	description => 'Unique FattMerchant customer ID',
    	format => '',
    	read_only => '',
    		},
    'deleted_at' => {
    ...
    'nickname' => {
    	datatype => 'string',
    	base_name => 'nickname',
    	description => 'Nickname given to the FattMerchant payment method',
    	format => '',
    	read_only => '',
    		},
    'updated_at' => {
