...
#
package KnetikCloud::Object::ImageGroupPropertyDefinitionResource;
...
__PACKAGE__->method_documentation({
    ...
    'max_height' => {
    	...
    	description => 'If provided, the maximum height of each image',
    	format => '',
    	read_only => '',
    		},
    'max_width' => {
    	datatype => 'int',
    	base_name => 'max_width',
    	description => 'If provided, the maximum width of each image',
    	format => '',
    	read_only => '',
    		},
    'min_height' => {
    	...
    	description => 'If provided, the minimum height of each image',
    	format => '',
    	read_only => '',
    		},
    'min_width' => {
    	datatype => 'int',
    	base_name => 'min_width',
    	description => 'If provided, the minumum width of each image',
    	format => '',
    	read_only => '',
    		},
});
