...
# @param OAuth2Authentication $authentication The authentication object (optional)
{
    my $params = {
    'bre_event' => {
        data_type => 'BreEvent',
    ...
    'authentication' => {
        data_type => 'OAuth2Authentication',
...
sub fire_event_using_post {
    ...
    # body params
    if ( exists $args{'authentication'}) {
        $_body_data = $args{'authentication'};
    }
