...
#
package KnetikCloud::Object::Sku;
...
__PACKAGE__->method_documentation({
    ...
    'description' => {
    	...
    	description => 'The friendly name of the SKU as it will appear on invoices and reports. Typically represents the option name like red, large, etc',
    	format => '',
    	read_only => '',
    		},
    'inventory' => {
