...
# @param string $state_code The code of the state (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_cities' } = { 
...
sub get_cities {
    ...
    unless (exists $args{'country_code_iso3'}) {
      croak("Missing the required parameter 'country_code_iso3' when calling get_cities");
    }

    # verify the required parameter 'state_code' is set
    unless (exists $args{'state_code'}) {
      croak("Missing the required parameter 'state_code' when calling get_cities");
    }
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_countries1' } = { 
...
# @param string $country_code_iso3 The iso3 code of the country (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_countries2' } = { 
...
sub get_countries2 {
    ...
    # verify the required parameter 'country_code_iso3' is set
    unless (exists $args{'country_code_iso3'}) {
      croak("Missing the required parameter 'country_code_iso3' when calling get_countries2");
    }
