...
# **update_category**
> update_category(id => $id, category => $category)
...
eval { 
    $api_instance->update_category(id => $id, category => $category);
};
if ($@) {
...
> update_category_template(id => $id, template => $template)
...
eval { 
    $api_instance->update_category_template(id => $id, template => $template);
};
if ($@) {
