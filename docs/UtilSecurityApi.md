...
my $api_instance = WWW::SwaggerClient::UtilSecurityApi->new();
my $authentication = WWW::SwaggerClient::Object::Authentication->new(); # Authentication | The Authentication Object

eval { 
    my $result = $api_instance->user_using_get(authentication => $authentication);
    print Dumper($result);
};
if ($@) {
