...
#
package KnetikCloud::GamificationAchievementsApi;
...
# @param TemplateResource $template The achievement template to be created (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_achievement_template' } = { 
...
#
sub create_achievement_template {
    my ($self, %args) = @_;
...
sub delete_achievement {
    ...
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_achievement");
    }
...
# @param string $cascade The value needed to delete used templates (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_achievement_template' } = { 
...
# @return void
#
sub delete_achievement_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_achievement_template");
    }
...
sub get_achievement {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling get_achievement");
    }
...
# @param string $id The id of the template (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_achievement_template' } = { 
...
# @return TemplateResource
#
sub get_achievement_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_achievement_template");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_achievement_templates' } = { 
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_achievement_triggers' } = { 
...
# @param boolean $filter_derived Filter for achievements that are derived from other services (optional, default to false)
{
    my $params = {
    'filter_tagset' => {
        data_type => 'string',
    ...
    'filter_derived' => {
        data_type => 'boolean',
        description => 'Filter for achievements that are derived from other services',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_achievements' } = { 
...
sub get_achievements {
    ...
    # query params
    if ( exists $args{'filter_derived'}) {
        $query_params->{'filter_derived'} = $self->{api_client}->to_query_value($args{'filter_derived'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PageResourceAchievementDefinitionResource', $response);
    return $_response_object;
}
...
# @param string $name The name of the derived achievement (required)
{
    ...
    'name' => {
        data_type => 'string',
        description => 'The name of the derived achievement',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_derived_achievements' } = { 
    	summary => 'Get a list of derived achievements',
        params => $params,
        returns => 'ARRAY[AchievementDefinitionResource]',
        };
}
# @return ARRAY[AchievementDefinitionResource]
#
sub get_derived_achievements {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling get_derived_achievements");
    }

    # parse inputs
    my $_resource_path = '/achievements/derived/{name}';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[AchievementDefinitionResource]', $response);
    return $_response_object;
}
...
# @param string $achievement_name The achievement&#39;s name (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_user_achievement_progress' } = { 
...
#
sub get_user_achievement_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_user_achievement_progress");
    }

    # verify the required parameter 'achievement_name' is set
    unless (exists $args{'achievement_name'}) {
      croak("Missing the required parameter 'achievement_name' when calling get_user_achievement_progress");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('UserAchievementGroupResource', $response);
    return $_response_object;
}
...
# 
# @param int $user_id The user&#39;s id (required)
# @param boolean $filter_achievement_derived Filter for achievements that are derived from other services (optional)
...
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_user_achievements_progress' } = { 
...
#
sub get_user_achievements_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_user_achievements_progress");
    }
    ...
    # query params
    if ( exists $args{'filter_achievement_derived'}) {
        $query_params->{'filter_achievement_derived'} = $self->{api_client}->to_query_value($args{'filter_achievement_derived'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PageResourceUserAchievementGroupResource', $response);
    return $_response_object;
}
...
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_users_achievement_progress' } = { 
...
# @return PageResourceUserAchievementGroupResource
#
sub get_users_achievement_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'achievement_name' is set
    unless (exists $args{'achievement_name'}) {
      croak("Missing the required parameter 'achievement_name' when calling get_users_achievement_progress");
    }
...
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_users_achievements_progress' } = { 
...
# @return PageResourceUserAchievementGroupResource
#
sub get_users_achievements_progress {
    my ($self, %args) = @_;
...
# @param IntWrapper $progress The amount to add to the progress value (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'increment_achievement_progress' } = { 
...
# @return UserAchievementGroupResource
#
sub increment_achievement_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling increment_achievement_progress");
    }

    # verify the required parameter 'achievement_name' is set
    unless (exists $args{'achievement_name'}) {
      croak("Missing the required parameter 'achievement_name' when calling increment_achievement_progress");
    }

    # parse inputs
    my $_resource_path = '/users/{user_id}/achievements/{achievement_name}/progress';
...
# @param IntWrapper $progress The new progress value (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_achievement_progress' } = { 
...
# @return UserAchievementGroupResource
#
sub set_achievement_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_achievement_progress");
    }

    # verify the required parameter 'achievement_name' is set
    unless (exists $args{'achievement_name'}) {
      croak("Missing the required parameter 'achievement_name' when calling set_achievement_progress");
    }
...
sub update_achievement {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling update_achievement");
    }
...
# @param TemplateResource $template The updated template (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_achievement_template' } = { 
...
# @return TemplateResource
#
sub update_achievement_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_achievement_template");
    }
