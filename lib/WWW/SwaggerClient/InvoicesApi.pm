...
# @param string $order_notes Payment status info (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_order_notes_using_put' } = { 
...
# @return void
#
sub set_order_notes_using_put {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling set_order_notes_using_put");
    }
