...
> update_artist_template(id => $id, artist_template_resource => $artist_template_resource)
...
eval { 
    $api_instance->update_artist_template(id => $id, artist_template_resource => $artist_template_resource);
};
if ($@) {
