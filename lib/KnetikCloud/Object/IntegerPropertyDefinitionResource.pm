...
#
package KnetikCloud::Object::IntegerPropertyDefinitionResource;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'IntegerPropertyDefinitionResource',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'max' => {
    	datatype => 'int',
    	base_name => 'max',
    	description => 'If provided, the maximum value',
    	format => '',
    	read_only => '',
    		},
    'min' => {
    	datatype => 'int',
    	base_name => 'min',
    	description => 'If provided, the minimum value',
    	format => '',
    	read_only => '',
    		},
});
