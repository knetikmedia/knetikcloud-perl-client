...
sub get_currencies_using_get1 {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageEntitlementItem', $response);
    return $_response_object;
}
...
sub get_inventory_list_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageUserInventoryResource', $response);
    return $_response_object;
}
...
sub get_user_inventory_log_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageUserItemLogResource', $response);
    return $_response_object;
}
