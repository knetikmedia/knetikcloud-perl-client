...
#
package KnetikCloud::Object::VideoGroupPropertyDefinitionResource;
...
__PACKAGE__->method_documentation({
    ...
    'max_height' => {
    	...
    	description => 'If provided, the maximum height of each video',
    	format => '',
    	read_only => '',
    		},
    'max_length' => {
    	...
    	description => 'If provided, the maximum length of each video',
    	format => '',
    	read_only => '',
    		},
    'max_width' => {
    	datatype => 'int',
    	base_name => 'max_width',
    	description => 'If provided, the maximum width of each video',
    	format => '',
    	read_only => '',
    		},
    'min_height' => {
    	...
    	description => 'If provided, the minimum height of each video',
    	format => '',
    	read_only => '',
    		},
    'min_length' => {
    	...
    	description => 'If provided, the minimum length of each video',
    	format => '',
    	read_only => '',
    		},
    'min_width' => {
    	datatype => 'int',
    	base_name => 'min_width',
    	description => 'If provided, the minimum width of each video',
    	format => '',
    	read_only => '',
    		},
});
