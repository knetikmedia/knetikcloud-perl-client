...
sub get_events_logs_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageBreEventLog', $response);
    return $_response_object;
}
...
sub get_forward_logs_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageForwardLog', $response);
    return $_response_object;
}
...
sub get_user_logs_using_get1 {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageUserActionLog', $response);
    return $_response_object;
}
