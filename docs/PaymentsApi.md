...
> update_payment_method(user_id => $user_id, id => $id, payment_method => $payment_method)
...
eval { 
    $api_instance->update_payment_method(user_id => $user_id, id => $id, payment_method => $payment_method);
};
if ($@) {
