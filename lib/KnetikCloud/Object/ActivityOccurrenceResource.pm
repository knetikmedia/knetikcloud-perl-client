...
__PACKAGE__->method_documentation({
    ...
    'settings' => {
    	...
    	base_name => 'settings',
    	description => 'The list of settings and their options available for this activity. Should be null on create if and only if part of an event. Otherwise, the set must exactly match those of the activity.',
    	format => '',
    	read_only => '',
    		},
    'simulated' => {
