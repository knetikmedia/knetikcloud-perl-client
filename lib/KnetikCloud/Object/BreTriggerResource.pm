...
#
package KnetikCloud::Object::BreTriggerResource;
...
__PACKAGE__->method_documentation({
    ...
    'parameters' => {
    	...
    	description => 'A list of parameters that will be sent with the event when the trigger is fired. These must be included in the event and match the described types',
    	format => '',
    	read_only => '',
    		},
    'system_trigger' => {
    ...
    'tags' => {
    	...
    	base_name => 'tags',
    	description => 'A list of tags for filtering',
    	format => '',
    	read_only => '',
    		},
    'trigger_description' => {
