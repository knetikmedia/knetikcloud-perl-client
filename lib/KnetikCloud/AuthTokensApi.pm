...
# @param string $client_id The id of the client (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_token' } = { 
...
sub delete_token {
    ...
    unless (exists $args{'username'}) {
      croak("Missing the required parameter 'username' when calling delete_token");
    }

    # verify the required parameter 'client_id' is set
    unless (exists $args{'client_id'}) {
      croak("Missing the required parameter 'client_id' when calling delete_token");
    }
...
sub delete_tokens {
    ...
    # verify the required parameter 'username' is set
    unless (exists $args{'username'}) {
      croak("Missing the required parameter 'username' when calling delete_tokens");
    }
