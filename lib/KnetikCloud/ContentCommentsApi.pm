...
#
package KnetikCloud::ContentCommentsApi;
...
# @param CommentResource $comment_resource The comment to be added (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'add_comment' } = { 
...
# @param int $id The comment id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_comment' } = { 
...
sub delete_comment {
    ...
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_comment");
    }
...
# @param int $id The comment id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_comment' } = { 
...
sub get_comment {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_comment");
    }
...
sub get_comments {
    ...
    unless (exists $args{'context'}) {
      croak("Missing the required parameter 'context' when calling get_comments");
    }

    # verify the required parameter 'context_id' is set
    unless (exists $args{'context_id'}) {
      croak("Missing the required parameter 'context_id' when calling get_comments");
    }
...
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
{
    ...
    __PACKAGE__->method_documentation->{ 'search_comments' } = { 
...
# @param StringWrapper $content The comment content (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_comment' } = { 
...
sub update_comment {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_comment");
    }
