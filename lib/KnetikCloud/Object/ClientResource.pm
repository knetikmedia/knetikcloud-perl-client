...
__PACKAGE__->method_documentation({
    ...
    'grant_types' => {
    	...
    	description => 'The oauth grant type as in: password (username/password auth), client_credentials (server-to-server, private clients), refresh_token (to allow clients to refresh their initial token), facebook, google, etc) See documentation for a compelte list.',
    	format => '',
    	read_only => '',
    		},
    'id' => {
