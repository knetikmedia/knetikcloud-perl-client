...
#
package KnetikCloud::Object::ImagePropertyDefinitionResource;
...
__PACKAGE__->method_documentation({
    ...
    'max_height' => {
    	...
    	description => 'If provided, the maximum height of the image',
    	format => '',
    	read_only => '',
    		},
    'max_width' => {
    	datatype => 'int',
    	base_name => 'max_width',
    	description => 'If provided, the maximum width of the image',
    	format => '',
    	read_only => '',
    		},
    'min_height' => {
    	...
    	description => 'If provided, the minimum height of the image',
    	format => '',
    	read_only => '',
    		},
    'min_width' => {
    	datatype => 'int',
    	base_name => 'min_width',
    	description => 'If provided, the minimum width of the image',
    	format => '',
    	read_only => '',
    		},
});
