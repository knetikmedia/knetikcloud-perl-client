...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'KnetikCloud::Configuration',
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Knetik Platform API Documentation latest ',
                          app_version => 'latest ',
...
sub _build_af {
	...
	return KnetikCloud::ApiFactory->new(%args);
}
...
=head2 Knetik Platform API Documentation latest  version: latest 
...
The tokens will be placed in the C<KnetikCloud::Configuration> namespace
as follows, but you don't need to know about this.

=over 4

=item C<$KnetikCloud::Configuration::username>

String. The username for basic auth.

=item C<$KnetikCloud::Configuration::password>

String. The password for basic auth.

=item C<$KnetikCloud::Configuration::api_key>
...
=item C<$KnetikCloud::Configuration::api_key_prefix>
...
=item C<$KnetikCloud::Configuration::access_token>
