...
# 
# @param int $filter_start_date_min events starting after this date, unix timestamp in seconds (optional)
# @param int $filter_start_date_max events starting before this date, unix timestamp in seconds (optional)
# @param int $filter_end_date_min events ending after this date, unix timestamp in seconds (optional)
# @param int $filter_end_date_max events ending before this date, unix timestamp in seconds (optional)
...
{
    my $params = {
    'filter_start_date_min' => {
        data_type => 'int',
        description => 'events starting after this date, unix timestamp in seconds',
        required => '0',
    },
    'filter_start_date_max' => {
        data_type => 'int',
        description => 'events starting before this date, unix timestamp in seconds',
        required => '0',
    },
    'filter_end_date_min' => {
        data_type => 'int',
        description => 'events ending after this date, unix timestamp in seconds',
        required => '0',
    },
    'filter_end_date_max' => {
        data_type => 'int',
        description => 'events ending before this date, unix timestamp in seconds',
        required => '0',
    },
    'filter_campaigns' => {
        data_type => 'boolean',
...
sub get_challenge_eventss_using_get {
    ...
    # query params
    if ( exists $args{'filter_start_date_min'}) {
        $query_params->{'filter_start_date_min'} = $self->{api_client}->to_query_value($args{'filter_start_date_min'});
    }

    # query params
    if ( exists $args{'filter_start_date_max'}) {
        $query_params->{'filter_start_date_max'} = $self->{api_client}->to_query_value($args{'filter_start_date_max'});
    }

    # query params
    if ( exists $args{'filter_end_date_min'}) {
        $query_params->{'filter_end_date_min'} = $self->{api_client}->to_query_value($args{'filter_end_date_min'});
    }

    # query params
    if ( exists $args{'filter_end_date_max'}) {
        $query_params->{'filter_end_date_max'} = $self->{api_client}->to_query_value($args{'filter_end_date_max'});
    }
