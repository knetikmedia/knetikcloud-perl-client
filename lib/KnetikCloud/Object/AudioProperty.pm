...
#
package KnetikCloud::Object::AudioProperty;
...
__PACKAGE__->method_documentation({
    ...
    'crc' => {
    	datatype => 'string',
    	base_name => 'crc',
    	description => 'A crc value for file integrity verification',
    	format => '',
    	read_only => '',
    		},
    'description' => {
    ...
    'file_type' => {
    	datatype => 'string',
    	base_name => 'file_type',
    	description => 'The type of file such as txt, mp3, mov or csv',
    	format => '',
    	read_only => '',
    		},
    'url' => {
