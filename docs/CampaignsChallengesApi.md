...
my $api_instance = WWW::SwaggerClient::CampaignsChallengesApi->new();
my $filter_start_date_min = 789; # int | events starting after this date, unix timestamp in seconds
my $filter_start_date_max = 789; # int | events starting before this date, unix timestamp in seconds
my $filter_end_date_min = 789; # int | events ending after this date, unix timestamp in seconds
my $filter_end_date_max = 789; # int | events ending before this date, unix timestamp in seconds
...
eval { 
    my $result = $api_instance->get_challenge_eventss_using_get(filter_start_date_min => $filter_start_date_min, filter_start_date_max => $filter_start_date_max, filter_end_date_min => $filter_end_date_min, filter_end_date_max => $filter_end_date_max, filter_campaigns => $filter_campaigns, filter_challenge => $filter_challenge, size => $size, page => $page, order => $order);
    print Dumper($result);
};
if ($@) {
