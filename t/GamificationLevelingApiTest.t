...
use_ok('KnetikCloud::GamificationLevelingApi');

my $api = KnetikCloud::GamificationLevelingApi->new();
isa_ok($api, 'KnetikCloud::GamificationLevelingApi');
...
#
{
    ...
    my $page = undef; # replace NULL with a proper value
    my $order = undef; # replace NULL with a proper value
    my $result = $api->get_user_levels(user_id => $user_id, filter_name => $filter_name, size => $size, page => $page, order => $order);
}

#
# increment_progress test
#
{
    my $user_id = undef; # replace NULL with a proper value
    my $name = undef; # replace NULL with a proper value
    my $progress = undef; # replace NULL with a proper value
    my $result = $api->increment_progress(user_id => $user_id, name => $name, progress => $progress);
}
...
#
{
    ...
    my $name = undef; # replace NULL with a proper value
    my $progress = undef; # replace NULL with a proper value
    my $result = $api->set_progress(user_id => $user_id, name => $name, progress => $progress);
}
