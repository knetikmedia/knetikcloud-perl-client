...
# @param AchievementProgressUpdateRequest $request The progress update details (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_achievement_progress' } = { 
...
# @return UserAchievementGroupResource
#
sub update_achievement_progress {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling update_achievement_progress");
    }

    # verify the required parameter 'achievement_name' is set
    unless (exists $args{'achievement_name'}) {
      croak("Missing the required parameter 'achievement_name' when calling update_achievement_progress");
    }
