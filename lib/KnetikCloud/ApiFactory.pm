...
#
package KnetikCloud::ApiFactory;
...
usesub KnetikCloud::Object;

use KnetikCloud::ApiClient;

=head1 Name

	KnetikCloud::ApiFactory - constructs APIs to retrieve KnetikCloud objects
...
=head1 Synopsis
	...
	my $api_factory = KnetikCloud::ApiFactory->new( ... ); # any args for ApiClient constructor
							  
	# later...
	my $pet_api = $api_factory->get_api('Pet');  
	
	# $pet_api isa KnetikCloud::PetApi
...
my %_apis = map { $_ =~ /^KnetikCloud::(.*)$/; $1 => $_ } 
			grep {$_ =~ /Api$/} 
			usesub 'KnetikCloud';

=head1 new($api_client)
	
	create a new KnetikCloud::ApiFactory instance with the given KnetikCloud::ApiClient instance.

=head1 new(%paramters)

	Any parameters are optional, and are passed to and stored on the api_client object.
	
	See L<KnetikCloud::ApiClient> and L<KnetikCloud::Configuration> for valid paramters
