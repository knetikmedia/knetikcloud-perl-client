...
#
{
    my $video_id = undef; # replace NULL with a proper value
    my $id = undef; # replace NULL with a proper value
    my $result = $api->delete_relationship_using_delete(video_id => $video_id, id => $id);
}
...
#
{
    ...
    my $result = $api->update_relationship_using_put(video_id => $video_id, relationship_id => $relationship_id, details => $details);
}
