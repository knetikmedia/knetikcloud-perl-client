...
# @param string $name The name of the derived achievement (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'find_all_by_group_name_using_get' } = { 
...
#
sub find_all_by_group_name_using_get {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling find_all_by_group_name_using_get");
    }
