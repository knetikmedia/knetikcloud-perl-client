...
#
package KnetikCloud::Object::ActivityResource;
...
__PACKAGE__->class_documentation({description => 'Represents an activity that can be parameterized and tracked through metrics (scores, etc)',
...
__PACKAGE__->method_documentation({
    ...
    'entitlements' => {
    	datatype => 'ARRAY[ActivityEntitlementResource]',
    	base_name => 'entitlements',
    	description => 'The list of items that can be used for entitlement (wager amounts/etc)',
    	format => '',
    	read_only => '',
    		},
    'id' => {
    ...
    'launch' => {
    	datatype => 'string',
    	base_name => 'launch',
    	description => 'Details about how to launch the activity',
    	format => '',
    	read_only => '',
    		},
    'long_description' => {
    ...
    'settings' => {
    	datatype => 'ARRAY[AvailableSettingResource]',
    	base_name => 'settings',
    	description => 'Define what parameters are required/available to start and run an activity. For example: Difficulty, Number of Questions, Character name, Avatar, Duration, etc. Not populated when getting listing',
    	format => '',
    	read_only => '',
    		},
    'short_description' => {
    ...
    'template' => {
    	datatype => 'boolean',
    	base_name => 'template',
    	description => 'Whether this activity is a template for other activities. Default: false',
    	format => '',
    	read_only => '',
    		},
    'template_id' => {
    	...
    	description => 'An activity template this activity is validated against (private). May be null and no validation of additional_properties will be done',
    	format => '',
    	read_only => '',
    		},
    'type' => {
    ...
    'unique_key' => {
    	...
    	description => 'The unique key (for static reference in code) of the activity',
    	format => '',
    	read_only => '',
    		},
    'updated_date' => {
