...
__PACKAGE__->class_documentation({description => 'A occurrence of an activity (the actual game for example). Used to track scores, participants, and provide settings',
...
__PACKAGE__->method_documentation({
    ...
    'settings' => {
    	...
    	base_name => 'settings',
    	description => 'The values selected from the available settings defined for the activity. Ex: difficulty: hard. Can be left out if the activity is played during an event and the settings are already set at the event level. Ex: every monday, difficulty: hard, number of questions: 10, category: sport. Otherwise, the set must exactly match those of the activity.',
    	format => '',
    	read_only => '',
    		},
    'simulated' => {
    	datatype => 'boolean',
    	base_name => 'simulated',
    	description => 'Whether this occurrence will be ran as a simulation. Simulations will not be rewarded. Useful for bot play or trials',
    	format => '',
    	read_only => '',
    		},
    'start_date' => {
    ...
    'users' => {
    	...
    	base_name => 'users',
    	description => 'The list of users participating in this occurrence. Can only be set directly with ACTIVITIES_ADMIN permission',
    	format => '',
    	read_only => '',
    		},
});
