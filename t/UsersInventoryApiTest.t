...
#
{
    ...
    my $result = $api->create_entitlement_item(entitlement_item => $entitlement_item);
}
...
#
{
    ...
    my $result = $api->get_user_inventory1(id => $id, inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_min_date => $filter_min_date, filter_max_date => $filter_max_date);
}
...
#
# get_user_inventory_log1 test
#
{
    my $user_id = undef; # replace NULL with a proper value
    my $id = undef; # replace NULL with a proper value
    my $timestamp = undef; # replace NULL with a proper value
    my $result = $api->get_user_inventory_log1(user_id => $user_id, id => $id, timestamp => $timestamp);
}
...
#
{
    ...
    my $result = $api->get_users_inventory(inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_username => $filter_username, filter_group => $filter_group, filter_date => $filter_date);
}
...
#
{
    my $entitlement_id = undef; # replace NULL with a proper value
    my $entitlement_item = undef; # replace NULL with a proper value
    my $result = $api->update_entitlement_item(entitlement_id => $entitlement_id, entitlement_item => $entitlement_item);
}
