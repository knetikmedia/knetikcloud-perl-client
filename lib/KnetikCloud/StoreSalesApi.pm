...
#
package KnetikCloud::StoreSalesApi;
...
# @param CatalogSale $catalog_sale The catalog sale object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_catalog_sale' } = { 
...
# @param int $id The id of the sale (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_catalog_sale' } = { 
...
# @return void
#
sub delete_catalog_sale {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_catalog_sale");
    }
...
# @param int $id The id of the sale (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_catalog_sale' } = { 
...
# @return CatalogSale
#
sub get_catalog_sale {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_catalog_sale");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_catalog_sales' } = { 
...
# @param CatalogSale $catalog_sale The catalog sale object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_catalog_sale' } = { 
...
# @return CatalogSale
#
sub update_catalog_sale {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_catalog_sale");
    }
