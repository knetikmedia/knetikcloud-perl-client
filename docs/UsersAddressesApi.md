...
# **update_address**
> update_address(user_id => $user_id, id => $id, saved_address_resource => $saved_address_resource)
...
eval { 
    $api_instance->update_address(user_id => $user_id, id => $id, saved_address_resource => $saved_address_resource);
};
if ($@) {
