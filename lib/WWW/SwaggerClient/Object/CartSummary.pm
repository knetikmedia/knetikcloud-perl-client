...
#
package WWW::SwaggerClient::Object::CartSummary;
...
__PACKAGE__->method_documentation({
    ...
    'currency_code' => {
    	...
    	description => 'The unique id code for the currency used in the cart',
    	format => '',
    	read_only => '',
    		},
    'grand_total' => {
    	...
    	description => 'The grand total for the cart',
    	format => '',
    	read_only => '',
    		},
    'id' => {
    ...
    'invoice_id' => {
    	...
    	description => 'The ID of the invoice associated with this cart',
    	format => '',
    	read_only => '',
    		},
    'items_in_cart' => {
    	datatype => 'int',
    	base_name => 'items_in_cart',
