...
#
package WWW::SwaggerClient::Object::StoreItemTemplateResource;
...
__PACKAGE__->method_documentation({
    'behaviors' => {
    	datatype => 'ARRAY[ItemBehaviorDefinitionResource]',
    	base_name => 'behaviors',
    	description => 'The customized behaviors that are required or default for this type of item',
    	format => '',
    	read_only => '',
    		},
    'created_date' => {
    ...
    'sku_template' => {
    	datatype => 'TemplateResource',
    	base_name => 'sku_template',
    	description => 'A template to apply to all skus on an item using this template',
    	format => '',
    	read_only => '',
    		},
    'updated_date' => {
