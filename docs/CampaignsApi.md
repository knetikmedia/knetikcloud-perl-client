...
# **update_campaign**
> update_campaign(id => $id, campaign_resource => $campaign_resource)
...
eval { 
    $api_instance->update_campaign(id => $id, campaign_resource => $campaign_resource);
};
if ($@) {
...
> update_campaign_template(id => $id, campaign_template_resource => $campaign_template_resource)
...
eval { 
    $api_instance->update_campaign_template(id => $id, campaign_template_resource => $campaign_template_resource);
};
if ($@) {
