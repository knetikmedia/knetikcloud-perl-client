...
# **update_bre_category**
> update_bre_category(name => $name, category => $category)
...
eval { 
    $api_instance->update_bre_category(name => $name, category => $category);
};
if ($@) {
...
> update_bre_category_template(id => $id, template => $template)
...
eval { 
    $api_instance->update_bre_category_template(id => $id, template => $template);
};
if ($@) {
