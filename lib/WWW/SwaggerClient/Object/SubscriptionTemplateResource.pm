...
#
package WWW::SwaggerClient::Object::SubscriptionTemplateResource;
...
__PACKAGE__->method_documentation({
    ...
    'plan_template' => {
    	...
    	base_name => 'plan_template',
    	description => 'A template to apply to all plans on a subscription using this template',
    	format => '',
    	read_only => '',
    		},
    'properties' => {
