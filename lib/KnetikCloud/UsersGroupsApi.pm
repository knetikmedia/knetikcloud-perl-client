...
# 
# @param string $filter_name Filter for groups whose name starts with provided string (optional)
# @param string $filter_unique_name Filter for groups whose unique_name starts with provided string (optional)
# @param string $filter_parent Filter for groups whose parent equals provided string (optional)
# @param int $size The number of objects returned per page (optional, default to 25)
# @param int $page The number of the page returned, starting with 1 (optional, default to 1)
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)
{
    ...
    'filter_name' => {
        data_type => 'string',
        description => 'Filter for groups whose name starts with provided string',
        required => '0',
    },
    'filter_unique_name' => {
        data_type => 'string',
    ...
    'filter_parent' => {
        data_type => 'string',
        description => 'Filter for groups whose parent equals provided string',
        required => '0',
    },
    'size' => {
        data_type => 'int',
