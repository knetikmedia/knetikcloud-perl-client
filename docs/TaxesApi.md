...
# **create_state_tax**
> create_state_tax(country_code_iso3 => $country_code_iso3, tax_resource => $tax_resource)
...
eval { 
    $api_instance->create_state_tax(country_code_iso3 => $country_code_iso3, tax_resource => $tax_resource);
};
if ($@) {
...
# **update_country_tax**
> update_country_tax(country_code_iso3 => $country_code_iso3, tax_resource => $tax_resource)
...
eval { 
    $api_instance->update_country_tax(country_code_iso3 => $country_code_iso3, tax_resource => $tax_resource);
};
if ($@) {
...
# **update_state_tax**
> update_state_tax(country_code_iso3 => $country_code_iso3, state_code => $state_code, tax_resource => $tax_resource)
...
eval { 
    $api_instance->update_state_tax(country_code_iso3 => $country_code_iso3, state_code => $state_code, tax_resource => $tax_resource);
};
if ($@) {
