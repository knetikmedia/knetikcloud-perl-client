...
> PageResourceUserInventoryResource get_user_inventories(id => $id, inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_min_date => $filter_min_date, filter_max_date => $filter_max_date)
...
eval { 
    my $result = $api_instance->get_user_inventories(id => $id, inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_min_date => $filter_min_date, filter_max_date => $filter_max_date);
    print Dumper($result);
};
if ($@) {
