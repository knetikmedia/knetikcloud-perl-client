...
#
package WWW::SwaggerClient::Object::UserRelationshipResource;
...
__PACKAGE__->method_documentation({
    ...
    'context' => {
    	datatype => 'string',
    	base_name => 'context',
    	description => 'Context about the relationship or its type',
    	format => '',
    	read_only => '',
    		},
    'id' => {
    	datatype => 'int',
    	base_name => 'id',
    	description => 'A generated unique id. Read-Only',
    	format => '',
    	read_only => '',
    		},
    'parent' => {
