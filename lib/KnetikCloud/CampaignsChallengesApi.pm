...
#
package KnetikCloud::CampaignsChallengesApi;
...
# @param ChallengeResource $challenge_resource The challenge resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_challenge' } = { 
...
# @param boolean $validate_settings Whether to validate the settings being sent against the available settings on the base activity. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_challenge_activity' } = { 
...
#
sub create_challenge_activity {
    my ($self, %args) = @_;

    # verify the required parameter 'challenge_id' is set
    unless (exists $args{'challenge_id'}) {
      croak("Missing the required parameter 'challenge_id' when calling create_challenge_activity");
    }
...
# 
# @param TemplateResource $challenge_activity_template_resource The challengeActivity template resource object (optional)
{
    my $params = {
    'challenge_activity_template_resource' => {
        data_type => 'TemplateResource',
        description => 'The challengeActivity template resource object',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'create_challenge_activity_template' } = { 
...
#
sub create_challenge_activity_template {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/challenge-activities/templates';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'challenge_activity_template_resource'}) {
        $_body_data = $args{'challenge_activity_template_resource'};
    }
...
# @param TemplateResource $challenge_template_resource The challenge template resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_challenge_template' } = { 
...
# @param int $id The challenge id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_challenge' } = { 
...
# @return void
#
sub delete_challenge {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_challenge");
    }
...
# @param int $challenge_id The challenge id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_challenge_activity' } = { 
...
sub delete_challenge_activity {
    ...
    # verify the required parameter 'challenge_id' is set
    unless (exists $args{'challenge_id'}) {
      croak("Missing the required parameter 'challenge_id' when calling delete_challenge_activity");
    }
...
# @param string $cascade The value needed to delete used templates (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_challenge_activity_template' } = { 
...
# @return void
#
sub delete_challenge_activity_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_challenge_activity_template");
    }

    # parse inputs
    my $_resource_path = '/challenge-activities/templates/{id}';
...
# @param int $id The challenge event id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_challenge_event' } = { 
...
# @return void
#
sub delete_challenge_event {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_challenge_event");
    }
...
# @param string $cascade The value needed to delete used templates (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_challenge_template' } = { 
...
# @return void
#
sub delete_challenge_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_challenge_template");
    }
...
# @param int $id The challenge id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge' } = { 
...
sub get_challenge {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_challenge");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_activities' } = { 
...
#
sub get_challenge_activities {
    my ($self, %args) = @_;

    # verify the required parameter 'challenge_id' is set
    unless (exists $args{'challenge_id'}) {
      croak("Missing the required parameter 'challenge_id' when calling get_challenge_activities");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PageResourceBareChallengeActivityResource', $response);
    return $_response_object;
}
...
# @param int $challenge_id The challenge id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_activity' } = { 
...
# @param string $id The id of the template (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_activity_template' } = { 
...
# @return TemplateResource
#
sub get_challenge_activity_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_challenge_activity_template");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_activity_templates' } = { 
...
#
sub get_challenge_activity_templates {
    my ($self, %args) = @_;
...
# @param int $id The challenge event id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_event' } = { 
...
#
sub get_challenge_event {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_challenge_event");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_events' } = { 
...
sub get_challenge_events {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageResourceChallengeEventResource', $response);
    return $_response_object;
}
...
# @param string $id The id of the template (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_template' } = { 
...
# @return TemplateResource
#
sub get_challenge_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_challenge_template");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_challenge_templates' } = { 
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    'filter_start_date' => {
        data_type => 'string',
        description => 'A comma separated string without spaces.  First value is the operator to search on, second value is the challenge start date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE).',
        required => '0',
    },
    'filter_end_date' => {
        data_type => 'string',
        description => 'A comma separated string without spaces.  First value is the operator to search on, second value is the challenge end date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE).',
        required => '0',
    },
    'size' => {
        data_type => 'int',
    ...
    __PACKAGE__->method_documentation->{ 'get_challenges' } = { 
...
# @param ChallengeResource $challenge_resource The challenge resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_challenge' } = { 
...
sub update_challenge {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_challenge");
    }
...
# @param ChallengeActivityResource $challenge_activity_resource The challenge activity resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_challenge_activity' } = { 
...
sub update_challenge_activity {
    ...
    # verify the required parameter 'challenge_id' is set
    unless (exists $args{'challenge_id'}) {
      croak("Missing the required parameter 'challenge_id' when calling update_challenge_activity");
    }
...
# @param TemplateResource $challenge_activity_template_resource The challengeActivity template resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_challenge_activity_template' } = { 
...
# @return TemplateResource
#
sub update_challenge_activity_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_challenge_activity_template");
    }
...
# @param TemplateResource $challenge_template_resource The challenge template resource object (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_challenge_template' } = { 
...
# @return TemplateResource
#
sub update_challenge_template {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_challenge_template");
    }
