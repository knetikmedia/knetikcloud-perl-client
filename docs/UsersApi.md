...
> update_user_template(id => $id, user_template_resource => $user_template_resource)
...
eval { 
    $api_instance->update_user_template(id => $id, user_template_resource => $user_template_resource);
};
if ($@) {
