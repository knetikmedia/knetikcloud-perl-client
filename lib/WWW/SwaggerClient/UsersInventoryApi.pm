...
# @param EntitlementGrantRequest $grant_request grantRequest (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'grant_entitlement_using_post' } = { 
...
# @return void
#
sub grant_entitlement_using_post {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling grant_entitlement_using_post");
    }

    # verify the required parameter 'grant_request' is set
    unless (exists $args{'grant_request'}) {
      croak("Missing the required parameter 'grant_request' when calling grant_entitlement_using_post");
    }
