...
# @param int $id id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_transaction_using_get' } = { 
...
#
sub get_transaction_using_get {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_transaction_using_get");
    }
...
# @param string $order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_transactions_using_get' } = { 
...
#
sub get_transactions_using_get {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('PageTransactionResource', $response);
    return $_response_object;
}
...
# @param RefundRequest $request Request containing refund details (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'refund_transaction_using_post' } = { 
...
#
sub refund_transaction_using_post {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling refund_transaction_using_post");
    }
