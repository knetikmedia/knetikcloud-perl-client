...
eval { 
    my $result = $api_instance->get_challenges(filter_template => $filter_template, filter_active_campaign => $filter_active_campaign);
    print Dumper($result);
};
if ($@) {
...
> update_challenge_activity(activity_id => $activity_id, challenge_id => $challenge_id, challenge_activity_resource => $challenge_activity_resource)
...
eval { 
    $api_instance->update_challenge_activity(activity_id => $activity_id, challenge_id => $challenge_id, challenge_activity_resource => $challenge_activity_resource);
};
if ($@) {
...
> update_challenge_template(id => $id, challenge_template_resource => $challenge_template_resource)
...
eval { 
    $api_instance->update_challenge_template(id => $id, challenge_template_resource => $challenge_template_resource);
};
if ($@) {
