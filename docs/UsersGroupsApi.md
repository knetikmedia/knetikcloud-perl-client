...
> delete_group_member_using_delete(unique_name => $unique_name, user_id => $user_id)
...
eval { 
    $api_instance->delete_group_member_using_delete(unique_name => $unique_name, user_id => $user_id);
};
if ($@) {
    warn "Exception when calling UsersGroupsApi->delete_group_member_using_delete: $@\n";
}
```
...
> delete_group_using_delete(unique_name => $unique_name)
...
eval { 
    $api_instance->delete_group_using_delete(unique_name => $unique_name);
};
if ($@) {
...
> ARRAY[string] get_group_list_using_get(user_id => $user_id)
...
eval { 
    my $result = $api_instance->get_group_list_using_get(user_id => $user_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling UsersGroupsApi->get_group_list_using_get: $@\n";
}
```
...
> GroupMemberResource get_group_member_using_get(unique_name => $unique_name, user_id => $user_id)
...
eval { 
    my $result = $api_instance->get_group_member_using_get(unique_name => $unique_name, user_id => $user_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling UsersGroupsApi->get_group_member_using_get: $@\n";
}
```
...
> PageResourceGroupMemberResource search_groups_using_get(unique_name => $unique_name, size => $size, page => $page, order => $order)
