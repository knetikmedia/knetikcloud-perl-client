...
eval { 
    my $result = $api_instance->create_coupon_item(coupon_item => $coupon_item);
    print Dumper($result);
};
if ($@) {
...
# **update_coupon_item**
> update_coupon_item(id => $id, coupon_item => $coupon_item)
...
eval { 
    $api_instance->update_coupon_item(id => $id, coupon_item => $coupon_item);
};
if ($@) {
...
> update_coupon_template(id => $id, coupon_template_resource => $coupon_template_resource)
...
eval { 
    $api_instance->update_coupon_template(id => $id, coupon_template_resource => $coupon_template_resource);
};
if ($@) {
