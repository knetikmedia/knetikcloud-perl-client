...
# @param int $user_id The id of the user to remove (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_group_member_using_delete' } = { 
...
# @return void
#
sub delete_group_member_using_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'unique_name' is set
    unless (exists $args{'unique_name'}) {
      croak("Missing the required parameter 'unique_name' when calling delete_group_member_using_delete");
    }

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling delete_group_member_using_delete");
    }
...
# @param int $user_id The id of the user (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_group_list_using_get' } = { 
...
# @return ARRAY[string]
#
sub get_group_list_using_get {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_group_list_using_get");
    }
...
# @param int $user_id The id of the user (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_group_member_using_get' } = { 
...
# @return GroupMemberResource
#
sub get_group_member_using_get {
    my ($self, %args) = @_;

    # verify the required parameter 'unique_name' is set
    unless (exists $args{'unique_name'}) {
      croak("Missing the required parameter 'unique_name' when calling get_group_member_using_get");
    }

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_group_member_using_get");
    }
