...
#
package WWW::SwaggerClient::Object::BreCategoryResource;
...
__PACKAGE__->method_documentation({
    ...
    'name' => {
    	datatype => 'string',
    	base_name => 'name',
    	description => 'The name of the category. Serves as the unique id',
    	format => '',
    	read_only => '',
    		},
    'template' => {
    	datatype => 'string',
    	base_name => 'template',
    	description => 'A template this BRE category is validated against (private). May be null and no validation of additional_properties will be done',
    	format => '',
    	read_only => '',
    		},
});
