...
# @param int $filter_max_date Filter for inventory added before the specified date, unix timestamp in seconds (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_user_inventory1' } = { 
...
#
sub get_user_inventory1 {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_user_inventory1");
    }
...
# @param int $timestamp The new expiration date as a unix timestamp in seconds. May be null (no body). (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_user_inventory_log1' } = { 
...
# @return void
#
sub get_user_inventory_log1 {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_user_inventory_log1");
    }

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_user_inventory_log1");
    }
