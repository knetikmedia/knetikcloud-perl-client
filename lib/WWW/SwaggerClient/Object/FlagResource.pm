...
#
package WWW::SwaggerClient::Object::FlagResource;
...
__PACKAGE__->method_documentation({
    ...
    'context_id' => {
    	...
    	description => 'The context_id of that resource',
    	format => '',
    	read_only => '',
    		},
    'created_date' => {
    ...
    'reason' => {
    	datatype => 'string',
    	base_name => 'reason',
    	description => 'The flag reason of that resource',
    	format => '',
    	read_only => '',
    		},
    'updated_date' => {
    ...
    'user' => {
    	...
    	base_name => 'user',
    	description => 'The basic user resource',
    	format => '',
    	read_only => '',
    		},
});
