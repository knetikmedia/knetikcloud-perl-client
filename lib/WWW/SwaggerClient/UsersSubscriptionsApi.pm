...
#
package WWW::SwaggerClient::UsersSubscriptionsApi;
...
# @param int $inventory_id The id of the user&#39;s inventory (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_subscription_details_using_get' } = { 
...
#
sub get_subscription_details_using_get {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_subscription_details_using_get");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling get_subscription_details_using_get");
    }
...
# @param int $user_id The id of the user (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_subscription_details_using_get1' } = { 
...
#
sub get_subscription_details_using_get1 {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_subscription_details_using_get1");
    }
...
# @param ReactivateSubscriptionRequest $reactivate_subscription_request The reactivate subscription request object inventory (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'reactivate_using_post' } = { 
...
#
sub reactivate_using_post {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling reactivate_using_post");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling reactivate_using_post");
    }
...
# @param int $bill_date The new bill date. Unix timestamp in seconds (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_bill_date_using_put' } = { 
...
# @return void
#
sub set_bill_date_using_put {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_bill_date_using_put");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling set_bill_date_using_put");
    }

    # verify the required parameter 'bill_date' is set
    unless (exists $args{'bill_date'}) {
      croak("Missing the required parameter 'bill_date' when calling set_bill_date_using_put");
    }
...
# @param int $payment_method_id The id of the payment method (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_payment_method_using_put' } = { 
...
# @return void
#
sub set_payment_method_using_put {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_payment_method_using_put");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling set_payment_method_using_put");
    }
...
# @param string $status The new status for the subscription. Actual options may differ from the indicated set if the invoice status type data has been altered.  Allowable values: (&#39;current&#39;, &#39;canceled&#39;, &#39;stopped&#39;, &#39;payment_failed&#39;, &#39;suspended&#39;) (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_status_using_put' } = { 
...
# @return void
#
sub set_status_using_put {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_status_using_put");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling set_status_using_put");
    }

    # verify the required parameter 'status' is set
    unless (exists $args{'status'}) {
      croak("Missing the required parameter 'status' when calling set_status_using_put");
    }
...
# @param string $plan_id The id of the new plan. Must be from the same subscription (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_user_plan_using_put' } = { 
...
# @return void
#
sub set_user_plan_using_put {
    my ($self, %args) = @_;

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_user_plan_using_put");
    }

    # verify the required parameter 'inventory_id' is set
    unless (exists $args{'inventory_id'}) {
      croak("Missing the required parameter 'inventory_id' when calling set_user_plan_using_put");
    }
