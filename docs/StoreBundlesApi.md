...
eval { 
    my $result = $api_instance->create_bundle_item(bundle_item => $bundle_item);
    print Dumper($result);
};
if ($@) {
...
# **update_bundle_item**
> update_bundle_item(id => $id, bundle_item => $bundle_item)
...
eval { 
    $api_instance->update_bundle_item(id => $id, bundle_item => $bundle_item);
};
if ($@) {
...
> update_bundle_template(id => $id, bundle_template_resource => $bundle_template_resource)
...
eval { 
    $api_instance->update_bundle_template(id => $id, bundle_template_resource => $bundle_template_resource);
};
if ($@) {
