...
#
package WWW::SwaggerClient::Object::VideoRelationshipResource;
...
__PACKAGE__->method_documentation({
    ...
    'relationship_details' => {
    	datatype => 'string',
    	base_name => 'relationship_details',
    	description => 'Details about the relationship such as type or other information. Max length 10 characters',
    	format => '',
    	read_only => '',
    		},
    'to' => {
