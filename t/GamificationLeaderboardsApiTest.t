...
use_ok('KnetikCloud::GamificationLeaderboardsApi');

my $api = KnetikCloud::GamificationLeaderboardsApi->new();
isa_ok($api, 'KnetikCloud::GamificationLeaderboardsApi');
...
#
{
    ...
    my $result = $api->get_leaderboard(context_type => $context_type, context_id => $context_id, size => $size, page => $page, order => $order);
}
