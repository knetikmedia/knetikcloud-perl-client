...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'list_ful_fillment_statuses' } = { 
...
# @return ARRAY[string]
#
sub list_ful_fillment_statuses {
    my ($self, %args) = @_;
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'list_payment_statuses' } = { 
