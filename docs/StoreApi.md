...
my $item_template_resource = WWW::SwaggerClient::Object::ItemTemplateResource->new(); # ItemTemplateResource | The new item template
...
> ItemTemplateResource get_item_template_using_get(id => $id)
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $id = 'id_example'; # string | The id of the template
my $item_template_resource = WWW::SwaggerClient::Object::ItemTemplateResource->new(); # ItemTemplateResource | The item template resource object
