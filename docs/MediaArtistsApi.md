# WWW::SwaggerClient::MediaArtistsApi

## Load the API package
```perl
use WWW::SwaggerClient::Object::MediaArtistsApi;
```
...
my $api_instance = WWW::SwaggerClient::MediaArtistsApi->new();
my $artist_resource = WWW::SwaggerClient::Object::ArtistResource->new(); # ArtistResource | The new artist

eval { 
    my $result = $api_instance->add_artist_using_post(artist_resource => $artist_resource);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->add_artist_using_post: $@\n";
}
```
...
my $api_instance = WWW::SwaggerClient::MediaArtistsApi->new();
my $artist_template_resource = WWW::SwaggerClient::Object::TemplateResource->new(); # TemplateResource | The artist template resource object

eval { 
    my $result = $api_instance->create_artist_template_using_post(artist_template_resource => $artist_template_resource);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->create_artist_template_using_post: $@\n";
}
```
...
> delete_artist_template_using_delete(id => $id, cascade => $cascade)
...
eval { 
    $api_instance->delete_artist_template_using_delete(id => $id, cascade => $cascade);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->delete_artist_template_using_delete: $@\n";
}
```
...
> delete_artist_using_delete(id => $id)
...
eval { 
    $api_instance->delete_artist_using_delete(id => $id);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->delete_artist_using_delete: $@\n";
}
```
...
> TemplateResource get_artist_template_using_get(id => $id)
...
eval { 
    my $result = $api_instance->get_artist_template_using_get(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->get_artist_template_using_get: $@\n";
}
```
...
eval { 
    my $result = $api_instance->get_artist_templates_using_get(size => $size, page => $page, order => $order);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->get_artist_templates_using_get: $@\n";
}
```
...
> ArtistResource get_artist_using_get(id => $id, show_contributions => $show_contributions)
...
eval { 
    my $result = $api_instance->get_artist_using_get(id => $id, show_contributions => $show_contributions);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->get_artist_using_get: $@\n";
}
```
...
eval { 
    my $result = $api_instance->search_artists_using_get(filter_artists_by_name => $filter_artists_by_name, size => $size, page => $page, order => $order);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->search_artists_using_get: $@\n";
}
```
...
> update_artist_template_using_put(id => $id, artist_template_resource => $artist_template_resource)
...
eval { 
    $api_instance->update_artist_template_using_put(id => $id, artist_template_resource => $artist_template_resource);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->update_artist_template_using_put: $@\n";
}
```
...
> update_artist_using_put(id => $id, artist_resource => $artist_resource)
...
eval { 
    $api_instance->update_artist_using_put(id => $id, artist_resource => $artist_resource);
};
if ($@) {
    warn "Exception when calling MediaArtistsApi->update_artist_using_put: $@\n";
}
```
