...
sub executive_revenue_country_sales_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageRevenueCountryReportResource', $response);
...
sub executive_revenue_product_sales_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageRevenueProductReportResource', $response);
    return $_response_object;
}
