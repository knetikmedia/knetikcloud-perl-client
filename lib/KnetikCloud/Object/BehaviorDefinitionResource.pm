...
#
package KnetikCloud::Object::BehaviorDefinitionResource;
...
__PACKAGE__->method_documentation({
    ...
    'prerequisite_behaviors' => {
    	...
    	base_name => 'prerequisite_behaviors',
    	description => 'Pre-requisite behaviors that an item must have in order to also have this behavior',
    	format => '',
    	read_only => '',
    		},
    'properties' => {
