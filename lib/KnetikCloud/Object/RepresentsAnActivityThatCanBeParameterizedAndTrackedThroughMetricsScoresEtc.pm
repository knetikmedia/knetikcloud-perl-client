...
#
package KnetikCloud::Object::RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc;
...
__PACKAGE__->method_documentation({
    ...
    'settings' => {
    	datatype => 'ARRAY[TheDefinitionOfAnActivityParametersExDifficultyLevel]',
    	base_name => 'settings',
