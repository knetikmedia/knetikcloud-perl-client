...
#
package KnetikCloud::AuthRolesApi;
...
sub delete_role {
    ...
    unless (exists $args{'role'}) {
      croak("Missing the required parameter 'role' when calling delete_role");
    }
...
# @param string $client_key The client key (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_client_roles' } = { 
...
#
sub get_client_roles {
    my ($self, %args) = @_;

    # verify the required parameter 'client_key' is set
    unless (exists $args{'client_key'}) {
      croak("Missing the required parameter 'client_key' when calling get_client_roles");
    }
...
sub get_role {
    ...
    # verify the required parameter 'role' is set
    unless (exists $args{'role'}) {
      croak("Missing the required parameter 'role' when calling get_role");
    }
...
sub get_user_roles {
    ...
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_user_roles");
    }
...
# @param ARRAY[string] $roles_list The list of unique roles (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_client_roles' } = { 
...
#
sub set_client_roles {
    my ($self, %args) = @_;

    # verify the required parameter 'client_key' is set
    unless (exists $args{'client_key'}) {
      croak("Missing the required parameter 'client_key' when calling set_client_roles");
    }
...
# @param ARRAY[string] $permissions_list The list of unique permissions (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_permissions_for_role' } = { 
...
# @return RoleResource
#
sub set_permissions_for_role {
    my ($self, %args) = @_;

    # verify the required parameter 'role' is set
    unless (exists $args{'role'}) {
      croak("Missing the required parameter 'role' when calling set_permissions_for_role");
    }
...
# @param ARRAY[string] $roles_list The list of unique roles (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_user_roles' } = { 
...
sub set_user_roles {
    ...
    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling set_user_roles");
    }
...
sub update_role {
    ...
    # verify the required parameter 'role' is set
    unless (exists $args{'role'}) {
      croak("Missing the required parameter 'role' when calling update_role");
    }
