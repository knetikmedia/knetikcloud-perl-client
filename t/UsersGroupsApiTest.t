...
#
{
    ...
    my $result = $api->add_member_to_group(unique_name => $unique_name, user => $user);
}

#
# add_members_to_group test
#
{
    my $unique_name = undef; # replace NULL with a proper value
    my $users = undef; # replace NULL with a proper value
    my $result = $api->add_members_to_group(unique_name => $unique_name, users => $users);
}
