...
#
package WWW::SwaggerClient::Object::QuestionTemplateResource;
...
__PACKAGE__->method_documentation({
    'answer_property' => {
    	datatype => 'PropertyDefinitionResource',
    	base_name => 'answer_property',
    	description => 'A property definition for all answers. If included each answer must match this definition&#39;s type and be valid',
    	format => '',
    	read_only => '',
    		},
    'created_date' => {
    ...
    'properties' => {
    	...
    	description => 'The customized properties that are present',
    	format => '',
    	read_only => '',
    		},
    'question_property' => {
    	datatype => 'PropertyDefinitionResource',
    	base_name => 'question_property',
    	description => 'A property definition for the question itself. If included the answer must match this definition&#39;s type and be valid',
    	format => '',
    	read_only => '',
    		},
    'updated_date' => {
