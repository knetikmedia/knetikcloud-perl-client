...
> delete_relationship_using_delete(video_id => $video_id, id => $id)
...
eval { 
    $api_instance->delete_relationship_using_delete(video_id => $video_id, id => $id);
};
if ($@) {
    warn "Exception when calling MediaVideosApi->delete_relationship_using_delete: $@\n";
}
```
...
> update_relationship_using_put(video_id => $video_id, relationship_id => $relationship_id, details => $details)
...
eval { 
    $api_instance->update_relationship_using_put(video_id => $video_id, relationship_id => $relationship_id, details => $details);
};
if ($@) {
    warn "Exception when calling MediaVideosApi->update_relationship_using_put: $@\n";
}
```
