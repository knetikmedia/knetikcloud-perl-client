...
# 
# @param ItemTemplateResource $item_template_resource The new item template (optional)
{
    my $params = {
...
sub get_store_items_using_get {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageStoreItem', $response);
    return $_response_object;
}
...
# 
# @param string $id The id of the template (required)
# @param ItemTemplateResource $item_template_resource The item template resource object (optional)
{
    my $params = {
    'id' => {
        data_type => 'string',
