...
my $filter_shipping = 3.4; # double | Filters invoices by shipping price
 ...
 **filter_shipping** | **double**| Filters invoices by shipping price | [optional] 
...
my $api_instance = WWW::SwaggerClient::InvoicesApi->new();
my $id = 56; # int | The id of the invoice
my $external_ref = WWW::SwaggerClient::Object::string->new(); # string | External reference info
