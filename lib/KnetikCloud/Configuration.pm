...
#
package KnetikCloud::Configuration;
...
=head1 Name
        ...
        KnetikCloud::Configuration - holds the configuration for all KnetikCloud Modules
...
sub new {
	...
	# base_url
        $p{base_url} //= 'https://sandbox.knetikcloud.com';
