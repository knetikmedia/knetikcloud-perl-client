...
#
{
    ...
    my $result = $api->get_invoices(filter_user => $filter_user, filter_email => $filter_email, filter_fulfillment_status => $filter_fulfillment_status, filter_payment_status => $filter_payment_status, filter_item_name => $filter_item_name, filter_created_date => $filter_created_date, size => $size, page => $page, order => $order);
}

#
# list_ful_fillment_statuses test
#
{
    my $result = $api->list_ful_fillment_statuses();
}

#
# list_payment_statuses test
#
{
    my $result = $api->list_payment_statuses();
}
