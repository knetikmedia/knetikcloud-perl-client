...
eval { 
    my $result = $api_instance->create_shipping_item(shipping_item => $shipping_item);
    print Dumper($result);
};
if ($@) {
...
> update_shipping_item(id => $id, shipping_item => $shipping_item)
...
eval { 
    $api_instance->update_shipping_item(id => $id, shipping_item => $shipping_item);
};
if ($@) {
...
> update_shipping_template(id => $id, shipping_template_resource => $shipping_template_resource)
...
eval { 
    $api_instance->update_shipping_template(id => $id, shipping_template_resource => $shipping_template_resource);
};
if ($@) {
