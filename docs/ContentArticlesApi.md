...
# **update_article**
> update_article(id => $id, article_resource => $article_resource)
...
eval { 
    $api_instance->update_article(id => $id, article_resource => $article_resource);
};
if ($@) {
...
> update_article_template(id => $id, article_template_resource => $article_template_resource)
...
eval { 
    $api_instance->update_article_template(id => $id, article_template_resource => $article_template_resource);
};
if ($@) {
