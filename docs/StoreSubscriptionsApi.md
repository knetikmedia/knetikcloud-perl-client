...
> update_subscription_template(id => $id, subscription_template_resource => $subscription_template_resource)
...
eval { 
    $api_instance->update_subscription_template(id => $id, subscription_template_resource => $subscription_template_resource);
};
if ($@) {
