...
eval { 
    my $result = $api_instance->create_entitlement_item(entitlement_item => $entitlement_item);
    print Dumper($result);
};
if ($@) {
...
# **get_user_inventory1**
> PageResourceUserInventoryResource get_user_inventory1(id => $id, inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_min_date => $filter_min_date, filter_max_date => $filter_max_date)
...
eval { 
    my $result = $api_instance->get_user_inventory1(id => $id, inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_min_date => $filter_min_date, filter_max_date => $filter_max_date);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling UsersInventoryApi->get_user_inventory1: $@\n";
}
```
...
> get_user_inventory_log1(user_id => $user_id, id => $id, timestamp => $timestamp)
...
eval { 
    $api_instance->get_user_inventory_log1(user_id => $user_id, id => $id, timestamp => $timestamp);
};
if ($@) {
    warn "Exception when calling UsersInventoryApi->get_user_inventory_log1: $@\n";
}
```
...
eval { 
    my $result = $api_instance->get_users_inventory(inactive => $inactive, size => $size, page => $page, filter_item_name => $filter_item_name, filter_username => $filter_username, filter_group => $filter_group, filter_date => $filter_date);
    print Dumper($result);
};
if ($@) {
...
> update_entitlement_item(entitlement_id => $entitlement_id, entitlement_item => $entitlement_item)
...
eval { 
    $api_instance->update_entitlement_item(entitlement_id => $entitlement_id, entitlement_item => $entitlement_item);
};
if ($@) {
...
> update_entitlement_template(id => $id, template => $template)
...
eval { 
    $api_instance->update_entitlement_template(id => $id, template => $template);
};
if ($@) {
