...
# **set_client_roles**
> set_client_roles(client_key => $client_key, roles_list => $roles_list)
...
eval { 
    $api_instance->set_client_roles(client_key => $client_key, roles_list => $roles_list);
};
if ($@) {
...
> set_permissions_for_role(role => $role, permissions_list => $permissions_list)
...
eval { 
    $api_instance->set_permissions_for_role(role => $role, permissions_list => $permissions_list);
};
if ($@) {
...
# **set_user_roles**
> set_user_roles(user_id => $user_id, roles_list => $roles_list)
...
eval { 
    $api_instance->set_user_roles(user_id => $user_id, roles_list => $roles_list);
};
if ($@) {
...
# **update_role**
> update_role(role => $role, role_resource => $role_resource)
...
eval { 
    $api_instance->update_role(role => $role, role_resource => $role_resource);
};
if ($@) {
